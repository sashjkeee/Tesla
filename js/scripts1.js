	...
	$('.button').click(function() {
		...
		if(answer != false)
		{
			var $form = $(this).parent(),
				...
				colors = $('#colors .active', $form).attr('data-color-name'),
				roof = $('#roofs .active', $form).attr('data-roof-name'),
				wheel = $('#wheels .active', $form).attr('data-wheel-name'),
				config = $('#config .active', $form).attr('data-config-name'),
...
$('#colors a').click( function(event) {
	...
	switch ( $(this).parent().attr('id') ) {
		case 'black_col': $('#color').css('background-position', '0 -44px'); $('#view_housing').animate({opacity: 0}, 'slow', function() { $(this).css('background', 'url("img/png/colors/black.png") no-repeat').animate({opacity: 1}); });
		break;
		case 'white_col': $('#color').css('background-position', '0 0'); $('#view_housing').animate({opacity: 0}, 'slow', function() { $(this).css('background', 'url("img/png/colors/white.png") no-repeat').animate({opacity: 1}); });
		break;
		case 'silver_col': $('#color').css('background-position', '0 -133px'); $('#view_housing').animate({opacity: 0}, 'slow', function() { $(this).css('background', 'url("img/png/colors/silver.png") no-repeat').animate({opacity: 1}); });
		break;
		case 'gray_col': $('#color').css('background-position', '0 -177px'); $('#view_housing').animate({opacity: 0}, 'slow', function() { $(this).css('background', 'url("img/png/colors/gray.png") no-repeat').animate({opacity: 1}); });
		break;
		case 'blue_col': $('#color').css('background-position', '0 -220px'); $('#view_housing').animate({opacity: 0}, 'slow', function() { $(this).css('background', 'url("img/png/colors/blue.png") no-repeat').animate({opacity: 1}); });
		break;
		case 'green_col': $('#color').css('background-position', '0 -264px'); $('#view_housing').animate({opacity: 0}, 'slow', function() { $(this).css('background', 'url("img/png/colors/green.png") no-repeat').animate({opacity: 1}); });
		break;
		case 'brown_col': $('#color').css('background-position', '0 -308px'); $('#view_housing').animate({opacity: 0}, 'slow', function() { $(this).css('background', 'url("img/png/colors/brown.png") no-repeat').animate({opacity: 1}); });
		break;
		case 'white2_col': $('#color').css('background-position', '0 -88px'); $('#view_housing').animate({opacity: 0}, 'slow', function() { $(this).css('background', 'url("img/png/colors/white_perl.png") no-repeat').animate({opacity: 1}); });
		break;
		case 'red_col': $('#color').css('background-position', '0 -352px'); $('#view_housing').animate({opacity: 0}, 'slow', function() { $(this).css('background', 'url("img/png/colors/red.png") no-repeat').animate({opacity: 1}); });
		break;
	}
});
$('#roofs a').on('click', function(event) {
	...
	$(this).toggleClass('active');
	switch ( $(this).parent().attr('id') ) {
		case 'solid_roof': $('#roof').css('background-position', '-240px 0'); $('#view_roof').animate({opacity: 0}, 'slow', function() { $(this).css('background', 'url("img/png/roofs/solid.png") no-repeat').animate({opacity: 1}); });
		break;
